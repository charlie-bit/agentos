...
5. Validate against the schema (until the P1b CLI exists: parse in a test, same pattern as `packages/contracts/src/__tests__`).
6. The registry drift check (declared vs discovered tools) at mount is the backstop.
